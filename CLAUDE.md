...
每次完成修改后，都使用下面的命令提交到github，为每个修改的文件都做好备注信息
# 第一步：将修改的文件添加到暂存区
# "." 代表当前目录下的所有文件，也可以换成具体文件名
git add .

# 第二步：提交代码并写入备注信息（关键步骤）
# -m 后面双引号内的内容即为“提交的备注信息”
git commit -m "这里写你的具体备注信息，例如：修复了登录页面的Bug"

# 第三步：推送到远程仓库（通常提交后需要推送）
git push